...
HD_PWD='C:/Users/stef_/OneDrive/Desktop/PROIECT/Proiect_Vivado/Proiect_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Prima_incercare.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Prima_incercare.tcl
