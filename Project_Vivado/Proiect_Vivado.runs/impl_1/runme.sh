...
HD_PWD='C:/Users/stef_/OneDrive/Desktop/PROIECT/Proiect_Vivado/Proiect_Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Prima_incercare.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Prima_incercare.tcl -notrace
